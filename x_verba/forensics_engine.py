"""X-Verba Forensics Engine — DC decomposition from code and logs. Coming in v0.5."""
...
NOT_IMPLEMENTED_MSG = """
This command is coming in v0.5.
...
class ForensicsEngine:
    def analyse(self, path, identity_key=None):
        ...
        return {
            ...
            "message": "x-verba forensics is coming in v0.5. See https://github.com/4vish/x-verba",
        }
