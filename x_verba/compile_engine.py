"""X-Verba Compile Engine — schema to executable VSL bundle. Coming in v0.7."""
...
NOT_IMPLEMENTED_MSG = """
This command is coming in v0.7.
...
class CompileEngine:
    def compile(self, schema, output=None):
        ...
        return {
            ...
            "message": "x-verba compile is coming in v0.7. See https://github.com/4vish/x-verba",
        }
