"""X-Verba Prompt Engine — governed prompt generation. Coming in v0.6."""
...
NOT_IMPLEMENTED_MSG = """
This command is coming in v0.6.
...
class PromptEngine:
    def generate(self, description=None, from_repo=None, domain="general"):
        ...
        return {
            ...
            "message": "x-verba prompt is coming in v0.6. See https://github.com/4vish/x-verba",
        }
